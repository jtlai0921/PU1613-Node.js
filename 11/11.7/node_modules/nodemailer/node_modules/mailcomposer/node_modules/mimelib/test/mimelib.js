...
exports["Quoted printable"] = {
    "Encode short string": function(test){
        test.equal("Tere =D5=C4=D6=DC!", mimelib.encodeQuotedPrintable("Tere OAOU!", null, "Latin_1"));
        test.equal("Tere =C3=95=C3=84=C3=96=C3=9C=C5=A0=C5=BD!", mimelib.encodeQuotedPrintable("Tere OAOUŠŽ!", null, "UTF-8"));
        test.equal("Tere =D0=DE!", mimelib.encodeQuotedPrintable("Tere ŠŽ!", null, "Win-1257"));
        test.done();
    },

    "parseMimeWords example": function(test){
        test.equal("Hello: See on ohin test", mimelib.parseMimeWords("Hello: =?UTF-8?q?See_on_=C3=B5hin_test?="));
        test.equal("=?UTF-8?Q?See_on_=C3=B5hin_test?=", mimelib.encodeMimeWord("See on ohin test"));
        test.equal("See on ohin test", mimelib.decodeMimeWord("=?UTF-8?q?See_on_=C3=B5hin_test?="));
        test.done();
    },
    ...
    "Wordwrap long string with UTF-8 sequence on edge": function(test){
        var longLine = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"+
                       "ABCDEFGHIAAAPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"+
                       "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"+
                       "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",
...
exports["Base64"] = {
    "Convert string": function(test){
        test.equal("VGVyZSDVxNbcIQ==", mimelib.encodeBase64("Tere OAOU!", "Latin_1"));
        test.done();
    },

    "Decode string": function(test){
        test.equal("Tere OAOU!", mimelib.decodeBase64("VGVyZSDVxNbcIQ==", "Latin_1"));
        test.done();
    }
}
...
exports["Mime Words"] = {
    "Encode Mime Word QP": function(test){
        test.equal("=?ISO-8859-13?Q?J=F5ge-va=DE?=", mimelib.encodeMimeWord("Joge-vaŽ", "Q", "iso-8859-13"));
        test.done();
    },

    "Decode Mime Word QP": function(test){
        test.equal("Joge-vaŽ", mimelib.decodeMimeWord("=?ISO-8859-13?Q?J=F5ge-va=DE?="));
        test.done();
    },

    "Parse Mime Words": function(test){
        test.equal("Joge-vaŽ zz Joge-vaŽJoge-vaŽJoge-vaŽ", mimelib.parseMimeWords("=?ISO-8859-13?Q?J=F5ge-va=DE?= zz =?ISO-8859-13?Q?J=F5ge-va=DE?= =?ISO-8859-13?Q?J=F5ge-va=DE?= =?ISO-8859-13?Q?J=F5ge-va=DE?="))
    ...
    "Split on maxLength QP": function(test){
        var inputStr = "Jogeva Jogeva Jogeva mugeva Jogeva Jogeva Jogeva Jogeva Jogeva",
...
exports["Fold long line"] = function(test){
    var inputStr = "Subject: Testin command line kirja okva kakva moni tonis kollas pollas tollas rollas jušla kušla tušla musla",
