...
function checkWhatIt(string){
	if(string == "")
		return -1;
	else if(string == "車" || string == "車")
		return 1;
	else if(string == "馬" || string == "馬")
		return 2;
	else if(string == "象" || string == "相")
		return 3;
	else if(string == "士" || string == "仕")
		return 4;
	else if(string == "將" || string == "將")
		return 5;
...
function checkWhichSide(string){
	if(string == "車"||string == "馬" ||string == "象"||string == "士"||string == "將"||string == "炮" ||string == "兵" )
		return 1;
	if(string == "車"||string == "馬" ||string == "相"||string == "仕"||string == "將"||string == "包" ||string == "卒" )
		return 2;
}
